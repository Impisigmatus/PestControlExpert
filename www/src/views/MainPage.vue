  ...
  <section class="promo" id="about">
    <div class="promo__title">
      ...
      <p class="promo__title_text">
        ...
        дератизации сети <b>кафе МУ-МУ</b>. Помимо этого, на постоянной основе -
    ...
    <div class="services__wrapper">
      <div class="services__item">
        ...
        <div class="services__descr">
          Комплекс организационных, санитарно-технических,
      ...
      <div class="services__item">
        ...
        <div class="services__descr">
          ...
          организационных, профилактических, истребительных мероприятий,
          проводимых с целью ликвидации или снижения численности грызунов и
          уменьшения их вредоносного воздействия.
        </div>
      </div>
      <div class="services__item">
        <img
        ...
        <div class="services__descr">
          ...
          (болезнетворных) и условно-патогенных микроорганизмов. Задачей
          дезинфекции является – противоэпидемические мероприятия, направленные
          на прерывание эпидемического процесса. Цель дезинфекции – удаление
      ...
      <div class="services__item">
        ...
        <div class="services__descr">
          ...
          общественных помещений и тд. Оценка санитарно-эпидемиологической
          ситуации в населенных пунктах, знание ареалов существующих очагов
          трансмиссивных инфекций и динамики численности переносчиков, позволяет
          прогнозировать эпидситуацию и выбирать максимально безопасные и
          щадящие методы их уничтожения.
        </div>
      </div>
    </div>
  </section>
